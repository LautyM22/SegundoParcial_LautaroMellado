...
$objE10 = new Equipo("Equipo Diez", "Cap.Diez", 10, $catMenores);
$objE11 = new Equipo("Equipo Once", "Cap.Once", 11, $catMayores);
$objE12 = new Equipo("Equipo Doce", "Cap.Doce", 12, $catMayores);

$torneo = new Torneo(100000);

// Crear partidos de básquet
$partido1 = new Basquetbol(11, '2024-05-05', $objE7, 80, $objE8, 120, 7);
$partido2 = new Basquetbol(12, '2024-05-06', $objE9, 81, $objE10, 110, 8);
$partido3 = new Basquetbol(13, '2024-05-07', $objE11, 115, $objE12, 85, 9);
